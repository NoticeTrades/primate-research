...
export const DASHBOARD_GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    howToUse: [
      ...
      'For live ratios from serverless hosts, prefer TWELVE_DATA_API_KEY (statistics) and/or a free FINNHUB_API_KEY before relying on Yahoo. Use FINANCIAL_MODELING_PREP_API_KEY only if you want one paid vendor for quarterly P/E history. ALPHA_VANTAGE_API_KEY is a backup; FRED_API_KEY helps if the public FRED CSV is blocked.',
    ],
    indicesAndMarkets: [
